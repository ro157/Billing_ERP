    ...
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Create a GST sales invoice</p>
        </div>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="CASH" onValueChange={(v) => form.setValue('paymentMode', v as InvoiceInput['paymentMode'])}>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="CGST_SGST" onValueChange={(v) => form.setValue('gstType', v as InvoiceInput['gstType'])}>
                  <SelectTrigger className="h-9"><SelectValue /></SelectTrigger>
                  <SelectContent>
